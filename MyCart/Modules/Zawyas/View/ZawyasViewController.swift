...
class ZawyasViewController: BaseViewController {

    // MARK: - Initialization
    init(viewModel: ZawyasViewModel) {
    ...
    // MARK: - variable
    private var viewModel: ZawyasViewModel!
    override var baseViewModel: BaseViewModel!{
        didSet{
            self.viewModel = baseViewModel as? ZawyasViewModel
        }
    }
...
extension ZawyasViewController : UITableViewDelegate, UITableViewDataSource {
